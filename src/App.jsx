        ...
        <section className="py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div
                className={
                  isHovering == 1 ? "absolute inset-0 bg-black opacity-50" : ""
                }
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className={`${isHovering == 1 ? "flex flex-col" : "hidden"}`}
                >
                  <a
            ...
            >
              ...
              <div
                className={
                  isHovering == 2 ? "absolute inset-0 bg-black opacity-50" : ""
                }
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                ...
                >
                  ...
                  <a
                    target="_blank"
                    href="https://github.com/SkyscrapersTM/chatgpt-clone"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                      className="w-4 h-4 mr-2 -ml-1"
            ...
            >
              ...
              <div
                className={
                  isHovering == 3 ? "absolute inset-0 bg-black opacity-50" : ""
                }
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className={`${isHovering == 3 ? "flex flex-col" : "hidden"}`}
                >
                  <a
                    href="https://saul-news-skyscraperstm.vercel.app"
                    target="_blank"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                  ...
                  <a
                    target="_blank"
                    href="https://github.com/SkyscrapersTM/saul-news.git"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                      className="w-4 h-4 mr-2 -ml-1"
            ...
            >
              ...
              <div
                className={
                  isHovering == 4 ? "absolute inset-0 bg-black opacity-50" : ""
                }
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className={`${isHovering == 4 ? "flex flex-col" : "hidden"}`}
                >
                  <a
                    href="https://stepzen-wheather-app.vercel.app/"
                    target="_blank"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                  ...
                  <a
                    target="_blank"
                    href="https://github.com/SkyscrapersTM/stepzen-wheather-app"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                      className="w-4 h-4 mr-2 -ml-1"
            ...
            >
              ...
              <div
                className={
                  isHovering == 5 ? "absolute inset-0 bg-black opacity-50" : ""
                }
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className={`${isHovering == 5 ? "flex flex-col" : "hidden"}`}
                >
                  <a
                    href="http://sm-optima-inmobiliaria.s3-website-us-east-1.amazonaws.com/login"
                    target="_blank"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                  ...
                  <a
                    target="_blank"
                    href="https://github.com/sauldevTM/sm-optimaInmobiliaria"
                    className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
                      className="w-4 h-4 mr-2 -ml-1"
